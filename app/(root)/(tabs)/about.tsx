    ...
    <AnimatedSafeAreaView style={{ flex: 1, backgroundColor: "white" }}>
        <ScrollView className="flex-1 bg-white px-4">
            <Image
                ...
                resizeMode="contain"
            />
            <Text className="text-2xl font-AnekBanglaBold leading-10 text-dark-green text-center mt-6">
                কুরআন ও হাদীস শরীফ বাংলায় 
            </Text>
            <Text className="text-sm leading-6 font-AnekBanglaMedium text-gray-700 text-justify mb-4">
