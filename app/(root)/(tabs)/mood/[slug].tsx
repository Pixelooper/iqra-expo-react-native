...
const MoodAyats: React.FC<MoodAyatsProps> = () => {
    ...
    const filteredAyats = !ayatData ? [] : ayatData.filter((ayat: ayat) =>
    ...
    const surahWithShapes = useAssignShapes(filteredAyats);
          ...
          {loading ? (
            ...
            <View style={{ flex: 1, paddingHorizontal: 16, marginTop: Platform.OS === 'ios' ? 0 : 35 }}>
              ...
              >
                ...
                >
                  <Title title={`আয়াত তালিকা: ${slug}`} subtitle="এখানে আপনি আপনার মেজাজের উপর ভিত্তি করে আয়াত পাবেন" btnText={false} />
                </Animated.View>
              </Animated.View>
              <TextInput
